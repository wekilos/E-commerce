        ...
        <div className="w-full pb-10   select-none">
            ...
            <div className="w-full mt-14 select-none ">
                <div className="flex items-center justify-between">
                    ...
                    <div
                        onClick={() =>
                            history.push({ pathname: "/mrt/kategories" })
                        }
            ...
            <div className=" mt-10">
                <div className="flex items-center justify-between">
                    ...
                    <div
                        onClick={() =>
                            history.push({ pathname: "/mrt/discount" })
                        }
                        className="border-[1px] hover:bg-green-200 border-[#E9EAEE] text-[#1D965C] cursor-pointer py-[5px] px-[12px] rounded-[24px] text-[16px] font-semi"
                    >
                        Hemmesini görkez
            ...
            <div className=" mt-10">
                <div className="flex items-center justify-between">
                    ...
                    <div
                        onClick={() =>
                            history.push({ pathname: "/mrt/moreSale" })
                        }
                        className="border-[1px] hover:bg-green-200 border-[#E9EAEE] text-[#1D965C] cursor-pointer py-[5px] px-[12px] rounded-[24px] text-[16px] font-semi"
                    >
                        Hemmesini görkez
            ...
            <div className="mt-10">
                <div className="w-full flex items-center justify-between">
                    ...
                    <div
                        onClick={() =>
                            history.push({ pathname: "/mrt/brends" })
                        }
                        className="border-[1px] hover:bg-green-200 border-[#E9EAEE] text-[#1D965C] cursor-pointer py-[5px] px-[12px] rounded-[24px] text-[16px] font-semi"
                    >
                        Hemmesini görkez
            ...
            <div className="my-10">
                <div className="flex items-center justify-between">
                    ...
                    <div
                        onClick={() =>
                            history.push({ pathname: "/mrt/kategory/1" })
                        }
                        className="border-[1px] hover:bg-green-200 border-[#E9EAEE] text-[#1D965C] cursor-pointer py-[5px] px-[12px] rounded-[24px] text-[16px] font-semi"
                    >
                        Hemmesini görkez
