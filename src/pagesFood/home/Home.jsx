...
function Home(props) {
    ...
    const sliderImages = [
        "https://images.unsplash.com/photo-1600891964599-f61ba0e24092?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxzZWFyY2h8Mnx8cmVzdGF1cmFudCUyMGZvb2R8ZW58MHx8MHx8&auto=format&fit=crop&w=800&q=60",
        "https://images.unsplash.com/photo-1544025162-d76694265947?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxzZWFyY2h8MTF8fHJlc3RhdXJhbnQlMjBmb29kfGVufDB8fDB8fA%3D%3D&auto=format&fit=crop&w=800&q=60",
        "https://images.unsplash.com/photo-1564758565388-0d5da0cbb08c?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxzZWFyY2h8MTV8fHJlc3RhdXJhbnQlMjBmb29kfGVufDB8fDB8fA%3D%3D&auto=format&fit=crop&w=800&q=60",
    ];
        ...
        <div className="w-full  pb-10  select-none">
            ...
            <div className="mt-14 w-full">
                <div className="w-full flex items-center justify-between">
                    ...
                    <div
                        onClick={() =>
                            history.push({ pathname: "/rtn/categories" })
                        }
            ...
            <div className="mt-10 w-full">
                <div className="flex items-center justify-between">
                    ...
                    <div
                        onClick={() =>
                            history.push({ pathname: "/rtn/discount" })
                        }
                        className="border-[1px] hover:bg-green-200 border-[#E9EAEE] text-[#1D965C] cursor-pointer py-[5px] px-[12px] rounded-[24px] text-[16px] font-semi"
                    >
                        Hemmesini görkez
                ...
                <div className="w-full mt-6 inline-flex justify-between scrollbar-hide overflow-y-auto">
            ...
            <div className="mt-10">
                <div className="flex items-center justify-between">
                    ...
                    <div
                        onClick={() =>
                            history.push({ pathname: "/rtn/moreSale" })
                        }
                        className="border-[1px] hover:bg-green-200 border-[#E9EAEE] text-[#1D965C] cursor-pointer py-[5px] px-[12px] rounded-[24px] text-[16px] font-semi"
                    >
                        Hemmesini görkez
            ...
            <div className="mt-10">
                <div className="flex items-center justify-between">
                    ...
                    <div
                        onClick={() =>
                            history.push({ pathname: "/rtn/category/1" })
                        }
                        className="border-[1px] hover:bg-green-200 border-[#E9EAEE] text-[#1D965C] cursor-pointer py-[5px] px-[12px] rounded-[24px] text-[16px] font-semi"
                    >
                        Hemmesini görkez
